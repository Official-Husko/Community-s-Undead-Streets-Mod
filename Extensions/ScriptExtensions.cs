...
namespace CWDM.Extensions
{
    public static class ScriptExtensions
    {
        ...
        {
            var scriptHash = Game.GenerateHash(script);
            if (!Function.Call<bool>((Hash) 0xF86AA3C56BA31381, scriptHash)) return;
            if (!Function.Call<bool>((Hash) 0x5F0F0C783EB16C04, scriptHash)) return;
