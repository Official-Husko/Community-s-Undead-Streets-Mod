...
namespace CWDM
{
    ...
    {
        public static bool CharacterReset;
        ...
        public static void SetCharacterModel()
        {
            ...
            if (PlayerModel.IsInCdImage && PlayerModel.IsValid)
            {
                ...
                if (PlayerGender == Gender.Male)
                {
                    Function.Call(Hash.SET_PED_HEAD_BLEND_DATA, Game.Player.Character.Handle, 44, 44, 0, 44, 44, 0,
                        1.0f, 1.0f, 0.0f, true);
                ...
                {
                    Function.Call(Hash.SET_PED_HEAD_BLEND_DATA, Game.Player.Character.Handle, 33, 33, 0, 33, 33, 0,
                        1.0f, 1.0f, 0.0f, true);
